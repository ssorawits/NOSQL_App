...
################################################################################
## Form generated from reading UI file 'GUI_BASE6.ui'
##
...
"border-radius: 5px;")
        ...
        self.verticalLayout_57 = QVBoxLayout(self.graph_dash)
        self.verticalLayout_57.setObjectName(u"verticalLayout_57")
        self.graphicsView = QGraphicsView(self.graph_dash)
        self.graphicsView.setObjectName(u"graphicsView")

        self.verticalLayout_57.addWidget(self.graphicsView)
...
#     def view_df_browse_func(self):
#         from browse_file_func import browse_csv
...
###### Add Branch ######
    def add_branch_to_mongodb(self):
        ...
        yearly_target = int(self.lineEdit_add_branch_price.text())

        try:
                collection.insert_one({"branch_name": branch_name, "yearly_target": yearly_target})
...
###### Remove Branch ######
    ...
    def view_remove_branch_table_func(self):
        ...
        # set label_17 to ""
        self.label_17.setText("Please select 1 row to remove data")
...
###### Edit Branch ######
    ...
    def view_edit_branch_table_func(self):
        ...
        # set label_17 to ""
        self.label_18.setText("Please select 1 row to edit data")
        # set label_print_result_branch_remove to ""
