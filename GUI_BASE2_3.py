...
"")
        ...
        if (self.table_bakery.columnCount() < 4):
            self.table_bakery.setColumnCount(4)
...
"")
        ...
        self.label_4 = QLabel(self.page_update_data)
...
"}")
        ...
        self.verticalLayout_19.addWidget(self.frame_main)
...
################################################
    ...
    def view_branch_table(self):
        import read_table_func
        df3 = read_table_func.read_branch_table()
        self.table_branch.setRowCount(len(df3))
        self.table_branch.setColumnCount(len(df3.columns))

        for i in range(len(df3)):
                for j in range(len(df3.columns)):
                        self.table_branch.setItem(i, j, QTableWidgetItem(str(df3.iloc[i, j])))
        self.table_branch.setHorizontalHeaderLabels(df3.columns)
        self.table_branch.resizeColumnsToContents()
        self.table_branch.resizeRowsToContents()  
...
################################################
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem.setText(QCoreApplication.translate("MainWindow", u"id_bakery", None));
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"bakery_category", None));
        ___qtablewidgetitem3 = self.table_bakery.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"unit_price", None));
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"Update Data", None))
        ...
        self.label_version.setText(QCoreApplication.translate("MainWindow", u" ", None))
    # retranslateUi
